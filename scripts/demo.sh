...
echo ""
echo "  Rule Packs:"
echo "    rule-packs/rule-pack-kubernetes.yaml      (預設)"
echo "    rule-packs/rule-pack-mariadb.yaml          (預設)"
echo "    rule-packs/rule-pack-redis.yaml            (選配)"
echo "    rule-packs/rule-pack-mongodb.yaml          (選配)"
echo "    rule-packs/rule-pack-elasticsearch.yaml    (選配)"
echo ""
