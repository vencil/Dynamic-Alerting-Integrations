...
FIX_COMMANDS: Dict[str, List[str]] = {
    "tool_map": ["generate_tool_map.py", "--generate", "--lang", "all"],
    "doc_map": ["generate_doc_map.py", "--generate", "--lang", "all"],
    "rule_pack_stats": ["generate_rule_pack_stats.py", "--generate", "--lang", "all"],
    "versions": ["validate_docs_versions.py", "--fix"],
    "alerts": ["generate_alert_reference.py"],
    "rule_packs": ["generate_rule_pack_readme.py", "--update"],
    "cheatsheet": ["generate_cheat_sheet.py", "--lang", "all"],
    "includes": ["check_includes_sync.py", "--fix"],
    "freshness": ["check_doc_freshness.py", "--fix"],
}
...
TOOLS = [
    ...
    ("cheatsheet", "generate_cheat_sheet.py", ["--check", "--lang", "all"], "Cheat sheet drift"),
    ...
    ("versions", "validate_docs_versions.py", ["--ci"], "Version/count consistency"),
    ("rule_pack_stats", "generate_rule_pack_stats.py", ["--check", "--lang", "all"], "Rule Pack stats include drift"),
    ("tool_map", "generate_tool_map.py", ["--check"], "Tool map coverage drift"),
    ("doc_map", "generate_doc_map.py", ["--check"], "Doc map coverage drift"),
]
