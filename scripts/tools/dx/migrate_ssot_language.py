...
Original v2.5.0 evaluation (archived in closed issue #145, see
https://github.com/vencil/Dynamic-Alerting-Integrations/issues/145)
...
參考：評估報告 §4 Migration Path 全文已歸檔於 closed issue #145
(https://github.com/vencil/Dynamic-Alerting-Integrations/issues/145，
