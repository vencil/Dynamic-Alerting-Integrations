...
6. **Doc-as-Code** — 影響 API / schema / CLI / 計數的變更，須同步 changelog（新增 `changelog.d/` 片段檔；`CHANGELOG.md` 的 `[Unreleased]` 已凍結，見 [`changelog.d/README.md`](changelog.d/README.md)）+ `CLAUDE.md` + `README.md`。
