...
> **v2.8.1** | Related docs: [ADR-016 (Architecture Decision)](../adr/016-conf-d-directory-hierarchy-mixed-mode.md), [ADR-017 (Inheritance)](../adr/017-defaults-yaml-inheritance-dual-hash.md)
