...
- 推薦的 baseline `30 × 25000 = 750k samples in flight` 是 Prom 預設 `200 × 10000 = 2M` 的 ~37%，**保守的安全起點**
...
- 設計 commitments locked from PR #375 strategic discussion + 多輪 adversarial review iterations
