...
docker run --rm -it ghcr.io/vencil/da-tools:v2.3.0 scaffold \
...
helm install threshold-exporter \
  oci://ghcr.io/vencil/charts/threshold-exporter:2.3.0 \
...
| **Low Adoption Cost** | Tenants learn PromQL (days), manual version sync | OCI Helm (one-line), `da-tools` container (20+ CLI tools) | `docker run ghcr.io/vencil/da-tools:v2.3.0 scaffold` |
...
- **Distribution**: OCI container (`ghcr.io/vencil/da-tools:v2.3.0`)
