...
docker run --rm -it ghcr.io/vencil/da-tools:v1.11.0 scaffold \
...
| **Low Adoption Cost** | Tenants learn PromQL (days), manual version sync | OCI Helm (one-line), `da-tools` container (20+ CLI tools) | `docker run ghcr.io/vencil/da-tools:v1.11.0 scaffold` |
...
- **Distribution**: OCI container (`ghcr.io/vencil/da-tools:v1.11.0`)
