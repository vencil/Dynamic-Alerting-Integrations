...
| 告警最佳實務系列 | SRE, Domain Expert, Tenant | [設計入門](alerting-design-fundamentals.md)（該對什麼告警） · [SLO 與錯誤預算](alerting-slo-error-budget.md)（該設多嚴） · [動作與冪等](alerting-best-practices.md)（響了之後的動作及格嗎） |
