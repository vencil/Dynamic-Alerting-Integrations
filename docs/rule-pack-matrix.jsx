...
const PACKS = [
  { key: 'mariadb',       label: 'MariaDB',        cat: 'Database',    rec: 11, alert: 8,  exporter: 'mysqld_exporter',         metrics: ['connections', 'cpu', 'memory', 'slow_queries', 'replication_lag', 'query_errors'] },
  { key: 'postgresql',    label: 'PostgreSQL',      cat: 'Database',    rec: 11, alert: 8,  exporter: 'postgres_exporter',       metrics: ['connections', 'cache_hit', 'query_time', 'disk_usage', 'replication_lag'] },
  ...
  { key: 'kafka',         label: 'Kafka',           cat: 'Messaging',   rec: 11, alert: 10, exporter: 'kafka_exporter',          metrics: ['consumer_lag', 'broker_active', 'controller', 'isr_shrink', 'under_replicated'] },
  { key: 'rabbitmq',      label: 'RabbitMQ',        cat: 'Messaging',   rec: 11, alert: 10, exporter: 'rabbitmq_exporter',       metrics: ['queue_depth', 'consumers', 'memory', 'disk_free', 'connections'] },
  { key: 'jvm',           label: 'JVM',             cat: 'Runtime',     rec: 10, alert: 8,  exporter: 'jmx_exporter / micrometer', metrics: ['gc_pause', 'heap_usage', 'thread_pool', 'class_loading'] },
  { key: 'nginx',         label: 'Nginx',           cat: 'Web Server',  rec: 8,  alert: 6,  exporter: 'nginx_exporter',          metrics: ['active_connections', 'request_rate', 'connection_backlog'] },
  { key: 'kubernetes',    label: 'Kubernetes',      cat: 'Infra',       rec: 7,  alert: 4,  exporter: 'kube-state-metrics',      metrics: ['pod_restart', 'cpu_limit', 'memory_limit', 'pvc_usage'] },
  { key: 'operational',   label: 'Operational',     cat: 'Infra',       rec: 0,  alert: 2,  exporter: '(built-in)',              metrics: ['exporter_health', 'config_reload'], required: true },
  { key: 'platform',      label: 'Platform',        cat: 'Infra',       rec: 0,  alert: 4,  exporter: '(built-in)',              metrics: ['threshold_metric_count', 'recording_rule_health', 'scrape_success'], required: true },
];
