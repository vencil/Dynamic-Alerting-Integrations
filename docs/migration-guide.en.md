...
>
> **Tip:** All `da-tools` commands can be executed directly via Docker (`docker run --rm --network=host ghcr.io/vencil/da-tools:v2.3.0 <cmd>`). The examples below use the simplified `da-tools <cmd>` notation.
