...
> **v2.9.1** | 相關文件：[ADR-011 PR-based Write-back](adr/011-pr-based-write-back.md) · [tenant-api README](https://github.com/vencil/Dynamic-Alerting-Integrations/blob/main/components/tenant-api/README.md) · [GitOps 部署指南](integration/gitops-deployment.md)
