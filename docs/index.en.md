...
| Alerting best-practices series | SREs, Domain Experts, Tenants | [Design fundamentals](alerting-design-fundamentals.en.md) (what to alert on) · [SLOs & error budgets](alerting-slo-error-budget.en.md) (how strict) · [Actions & idempotency](alerting-best-practices.en.md) (is the action itself sound?) |
