    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <div className="bg-white border-b border-slate-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-8">
          <h1 className="text-4xl font-bold text-slate-900">Platform Demo</h1>
          <p className="text-slate-600 mt-2 text-lg">
            Experience the <code className="bg-slate-100 px-2 py-1 rounded text-sm font-mono">make demo</code> workflow — no cluster required
          </p>
        </div>
      </div>
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="flex flex-wrap gap-3 items-center">
              ...
              >
                ...
                <option value={20}>Speed: Normal</option>
            ...
            <div className="flex gap-4 justify-between">
              ...
              <div className="text-center text-slate-600 font-medium">
                Phase {currentPhaseIdx + 1} of {PHASE_CONFIG.length}
              </div>
            ...
            {allCompleted && (
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg p-6 shadow-sm">
                <h3 className="text-xl font-bold text-green-900">Demo Complete!</h3>
                <p className="text-green-800 mt-2">
                  You've successfully walked through the entire <code className="bg-green-100 px-2 py-1 rounded text-sm font-mono">make demo</code> workflow.
                </p>
