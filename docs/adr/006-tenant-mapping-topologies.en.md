...
✅ Recording Rules support hot reload (config-reloader sidecar — actually deployed only in #1246; before that a manual reload was required), no Prometheus restart needed
