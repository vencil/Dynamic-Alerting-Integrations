...
/* ── Rule Pack nodes with positions and dependencies ── */
const PACKS = [
  { id: 'kubernetes', label: 'Kubernetes', category: 'infra', exporter: 'kube-state-metrics', metrics: 30, alerts: 18 },
  ...
  { id: 'mariadb', label: 'MariaDB', category: 'database', exporter: 'mysqld_exporter', metrics: 25, alerts: 15 },
  { id: 'postgresql', label: 'PostgreSQL', category: 'database', exporter: 'postgres_exporter', metrics: 20, alerts: 12 },
  { id: 'redis', label: 'Redis', category: 'database', exporter: 'redis_exporter', metrics: 15, alerts: 10 },
  { id: 'mongodb', label: 'MongoDB', category: 'database', exporter: 'mongodb_exporter', metrics: 18, alerts: 8 },
  { id: 'kafka', label: 'Kafka', category: 'middleware', exporter: 'kafka_exporter', metrics: 22, alerts: 11 },
  { id: 'elasticsearch', label: 'Elasticsearch', category: 'middleware', exporter: 'elasticsearch_exporter', metrics: 20, alerts: 9 },
  { id: 'rabbitmq', label: 'RabbitMQ', category: 'middleware', exporter: 'rabbitmq_exporter', metrics: 14, alerts: 7 },
  { id: 'nginx', label: 'Nginx', category: 'middleware', exporter: 'nginx_exporter', metrics: 10, alerts: 6 },
  { id: 'jvm', label: 'JVM', category: 'runtime', exporter: 'jmx_exporter', metrics: 12, alerts: 7 },
