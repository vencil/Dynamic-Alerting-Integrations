...
| `deprecate` | Deprecate metrics: remove their keys from defaults/optional_overrides/tenants | --config-dir <PATH>, --execute, --plane {root,subtree} | `da-tools deprecate --help` |
