...
- ⛔ **另外七條已知限制（#1396 第三／四／五輪盲審開出,刻意不在那些 PR 修——都要動整體錯誤策略或引入票／bench 的身分識別）**:
  ...
  6. **held-open 夜的帳本收縮不發 transition comment**——該路徑本來就不留言,所以一支 bench 在 held-open 夜恢復時沒有人被通知。比反過來的假復原安全,但仍是缺口。
