...
superseded-by: "../../benchmark-playbook.md#v280-phase-2-e2e-alert-fire-through-b-1-phase-2"
lang: zh
---

> ⚠️ **ARCHIVED 2026-04-26** — design doc for the e2e harness is archived
> after implementation completed and first baselines landed. See
> `docs/internal/benchmark-playbook.md` §v2.8.0 Phase 2 e2e for the
> living ops content (including the 1000-tenant + 5000-tenant baseline
> numbers). The design rationale, decision log, and rejected
> alternatives below are preserved for historical reference only — do
> not edit. RCA chain that retroactively challenged design §8.1's
> "first-real-run surprise is accepted cost" premise: see archive
> §S#37d (6-cycle RCA) and §S#45 (Tier 1 fail-fast follow-up).

# Phase 2 E2E Harness — Alert Fire-through Latency Design

> **受眾**：Maintainers、Platform Engineers
> **版本**：v2.9.0（草案 → v2.8.0 phase .b 完整 land）
