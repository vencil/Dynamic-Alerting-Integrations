...
**測試環境：** Kind 單節點叢集（Intel Core 7 240H），2 個租戶，237 個規則（15 Rule Packs），43 個規則群組。所有數據於 v2.1.0 統一採集。
...
## 10. Under-Load 基準（100 Synthetic Tenants）
