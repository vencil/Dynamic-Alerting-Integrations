...
| `7` | What the ConfigMap now holds cannot be told (not readable, or neither version), or another writer changed the patched key after this write (not rolled back; their change is kept); check it by hand |
