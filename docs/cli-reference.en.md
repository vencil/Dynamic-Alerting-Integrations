...
> **Container Image**: `ghcr.io/vencil/da-tools:v2.6.0`
...
> ⚠️ After rollback, CRD files generated by Operator remain in the `operator-output/` directory and can be re-applied at any time.
