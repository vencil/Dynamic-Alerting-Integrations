import{a as M}from"./chunk-B7RYC3SZ.js";import{a as h,b as R,c as U,d as $,e as G}from"./chunk-IP76M35X.js";var _=h(R(),1),H=h(U(),1);var p=h(R(),1);var l=window.__t||((m,i)=>i),I=[{id:"tier",label:()=>l("\u90E8\u7F72\u5C64\u7D1A","Deployment Tier")},{id:"environment",label:()=>l("\u904B\u884C\u74B0\u5883","Environment")},{id:"tenants",label:()=>l("Tenant \u6578\u91CF","Tenant Count")},{id:"auth",label:()=>l("\u8A8D\u8B49 (Tier 2)","Authentication (Tier 2)")},{id:"packs",label:()=>l("Rule Packs","Rule Packs")},{id:"review",label:()=>l("\u6AA2\u8996\u8207\u7522\u51FA","Review & Generate")}],P=[{id:"tier1",name:l("Tier 1\uFF1AGit-Native","Tier 1: Git-Native"),desc:l("\u7D14 GitOps\uFF1AYAML + da-tools CLI + Helm values","Pure GitOps: YAML + da-tools CLI + Helm values"),features:[l("threshold-exporter \xD7 2 (HA)","threshold-exporter \xD7 2 (HA)"),l("Prometheus + Alertmanager (Helm)","Prometheus + Alertmanager (Helm)"),l("ConfigMap \u7BA1\u7406\u544A\u8B66\u898F\u5247","ConfigMap for alert rules"),l("\u7121 Portal / API","No Portal / API")],icon:"\u{1F4E6}",cost:l("\u4F4E","Low")},{id:"tier2",name:l("Tier 2\uFF1APortal + API","Tier 2: Portal + API"),desc:l("\u5B8C\u6574\u529F\u80FD\uFF1ATier 1 + da-portal + tenant-api + OAuth2","Full-featured: Tier 1 + da-portal + tenant-api + OAuth2"),features:[l("\u6240\u6709 Tier 1 \u529F\u80FD","All Tier 1 features"),l("da-portal UI (\u81EA\u8A17\u7BA1\u6216 SaaS)","da-portal UI (self-hosted or SaaS)"),l("tenant-api\uFF08RBAC + \u71B1\u66F4\u65B0\uFF09","tenant-api (RBAC + hot-reload)"),l("oauth2-proxy\uFF08GitHub / Google / OIDC\uFF09","oauth2-proxy (GitHub / Google / OIDC)")],icon:"\u{1F310}",cost:l("\u4E2D","Medium")}],k=[{id:"local",label:l("\u672C\u5730\u958B\u767C (Kind/Minikube)","Local Dev (Kind/Minikube)"),icon:"\u{1F4BB}",desc:l("2\u20134 CPU, 4\u20138 GB RAM, \u7C21\u5316\u90E8\u7F72","2\u20134 CPU, 4\u20138 GB RAM, simplified")},{id:"staging",label:l("\u6E2C\u8A66\u74B0\u5883 (Staging)","Staging Environment"),icon:"\u{1F9EA}",desc:l("4\u20138 CPU, 16 GB RAM, HA \u5C31\u7DD2","4\u20138 CPU, 16 GB RAM, HA-ready")},{id:"production",label:l("\u751F\u7522\u74B0\u5883 (Production)","Production Environment"),icon:"\u{1F680}",desc:l("8+ CPU, 32+ GB RAM, \u591A\u5340\u57DF","8+ CPU, 32+ GB RAM, multi-region")}],S=[{id:"small",label:l("\u5C0F\u578B (1\u201310)","Small (1\u201310)"),icon:"1\uFE0F\u20E3",replicas:{exporter:1,prometheus:1,alertmanager:1},retention:"7d",cardinality:500},{id:"medium",label:l("\u4E2D\u578B (10\u201350)","Medium (10\u201350)"),icon:"\u{1F4CA}",replicas:{exporter:2,prometheus:2,alertmanager:3},retention:"14d",cardinality:2e3},{id:"large",label:l("\u5927\u578B (50+)","Large (50+)"),icon:"\u{1F4C8}",replicas:{exporter:3,prometheus:3,alertmanager:3},retention:"30d",cardinality:5e3}],C=[{id:"github",label:"GitHub",icon:"\u{1F419}",desc:l("\u4F7F\u7528 GitHub \u5E33\u6236\u767B\u5165","Sign in with GitHub account"),scopes:["user:email","read:org"]},{id:"google",label:"Google",icon:"\u{1F535}",desc:l("\u4F7F\u7528 Google \u5E33\u6236\u767B\u5165","Sign in with Google account"),scopes:["openid","email","profile"]},{id:"oidc",label:"OIDC / Keycloak",icon:"\u{1F510}",desc:l("\u81EA\u8A17\u7BA1 OIDC\uFF08Keycloak\u3001Okta \u7B49\uFF09","Self-hosted OIDC (Keycloak, Okta, etc.)"),scopes:["openid","profile","email"]},{id:"gitlab",label:"GitLab",icon:"\u{1F98A}",desc:l("\u4F7F\u7528 GitLab \u5E33\u6236\u767B\u5165","Sign in with GitLab account"),scopes:["openid","profile","email"]}],E=[{id:"mariadb",label:"MariaDB/MySQL",category:"database",icon:"\u{1F42C}"},{id:"postgresql",label:"PostgreSQL",category:"database",icon:"\u{1F418}"},{id:"redis",label:"Redis",category:"database",icon:"\u{1F534}"},{id:"mongodb",label:"MongoDB",category:"database",icon:"\u{1F343}"},{id:"elasticsearch",label:"Elasticsearch",category:"database",icon:"\u{1F50E}"},{id:"oracle",label:"Oracle",category:"database",icon:"\u{1F3DB}\uFE0F"},{id:"db2",label:"DB2",category:"database",icon:"\u{1F537}"},{id:"clickhouse",label:"ClickHouse",category:"database",icon:"\u{1F5B1}\uFE0F"},{id:"kafka",label:"Kafka",category:"messaging",icon:"\u{1F4E8}"},{id:"rabbitmq",label:"RabbitMQ",category:"messaging",icon:"\u{1F430}"},{id:"jvm",label:"JVM",category:"runtime",icon:"\u2615"},{id:"nginx",label:"Nginx",category:"webserver",icon:"\u{1F310}"},{id:"kubernetes",label:"Kubernetes",category:"infrastructure",icon:"\u2388"}];window.__DEPLOY_TIERS=P;window.__DEPLOY_ENVIRONMENTS=k;window.__DEPLOY_TENANT_SIZES=S;function D(m){let i=window.__DEPLOY_TIERS||[],r=window.__DEPLOY_ENVIRONMENTS||[],c=window.__DEPLOY_TENANT_SIZES||[],{tier:x,environment:o,tenantSize:N,auth:g,packs:y}=m,d=c.find(s=>s.id===N),b=x==="tier2";return`# Generated Helm values for ${i.find(s=>s.id===x)?.name}
# Environment: ${r.find(s=>s.id===o)?.label}
# Tenant count: ${d?.label}
...
thresholdExporter:
  replicaCount: ${d?.replicas.exporter||2}
  image:
  ...
  cardinalityGuard:
    enabled: true
    maxPerTenant: ${d?.cardinality||2e3}
...
prometheus:
  replicaCount: ${d?.replicas.prometheus||2}
  image:
  ...
  retention: "${d?.retention||"14d"}"

  # Rule packs from ConfigMap + Projected Volume
  ruleConfigMaps:
    - name: platform-rules
      key: rules.yaml
    ${y.length>0?`# Auto-mounted rule packs via Projected Volume:
    # ${y.map(s=>`- name: rules-${s}`).join(`
    # `)}`:""}
...
alertmanager:
  replicaCount: ${d?.replicas.alertmanager||3}
  image:
...
daPortal:
  enabled: true
  replicaCount: ${o==="local"?1:d?.replicas.exporter||2}
  image:
