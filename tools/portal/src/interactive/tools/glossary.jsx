...
const GLOSSARY = [
  ...
  { term: 'Projected Volume', category: 'Kubernetes', def: 'A Kubernetes volume that combines multiple ConfigMaps into a single mount point. Used to mount all 16 Rule Pack ConfigMaps into the Prometheus container.', related: ['Rule Pack', 'ConfigMap'] },
