...
const RULE_PACK_DATA = window.__PLATFORM_DATA?.rulePacks || {
  ...
  platform: { label: 'Platform', category: 'infrastructure', exporter: 'threshold-exporter', configMap: 'prometheus-rules-platform', recordingRules: 0, alertRules: 41, required: true, defaults: {}, metrics: ['threshold_metric_count', 'recording_rule_health', 'scrape_success'] },
};
