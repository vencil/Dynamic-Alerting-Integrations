...
dependencies: [
  "cost-estimator/calc.js"
]
---

import React, { useState, useMemo } from 'react';

// PR-portal-12: pure resource/cost math extracted to a unit-testable module.
// PRICING is re-imported here for the "AWS defaults" footnote so the math and
// the displayed unit prices stay a single source of truth.
import { calcTotalResources, PRICING } from './cost-estimator/calc.js';
