...
// PR-portal-17: template validation / extraction / preview-render / export
// extracted to a unit-testable engine (was inline + 0%-covered). generateYAML/
// generateJSON take receiverLabel as an arg (de-coupled from RECEIVER_TYPES).
import {
  validateTemplate,
  extractVariables,
  ...
  return (
    <div style={styles.space}>
      ...
      <div style={{ marginBottom: 'var(--da-space-3)' }}>
        ...
        <div style={styles.codeBlock}>
          <pre style={{ margin: 0, whiteSpace: 'pre-wrap', wordWrap: 'break-word' }}>
            {generateYAML(receiverType, template, receiverLabel)}
          </pre>
        </div>
        <button
      ...
      <div style={{ marginBottom: 'var(--da-space-3)' }}>
        ...
        <div style={styles.codeBlock}>
          <pre style={{ margin: 0, whiteSpace: 'pre-wrap', wordWrap: 'break-word' }}>
            {generateJSON(receiverType, template, receiverLabel)}
          </pre>
        </div>
        <button
