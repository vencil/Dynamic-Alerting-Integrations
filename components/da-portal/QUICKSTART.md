# da-portal — 38 interactive alerting & ops tools, right in your browser

> **把複雜的 PromQL 與告警配置封進 38 個瀏覽器互動工具——打開就玩，零安裝。**
> *38 interactive alerting/ops tools in your browser — zero install.*

|  |  |
|---|---|
| **What / 是什麼** | self-service portal：alert builder / PromQL tester / threshold calculator / cost estimator / rule-pack selector…共 38 個工具。*A self-service portal of 38 interactive tools.* |
...
| **→ You'll see** | 38 個互動工具的儀表板，**立即可玩**。*A dashboard of 38 interactive tools, instantly.* |
...
## Next
- ← **Try the full stack**：[`try-local/`](../../try-local/)（Mode 0 核心雙星 + 完整監控網格與告警紅燈）
- → **Move to production**：[`helm/da-portal/`](../../helm/da-portal/)（nginx 靜態服務 + ingress / oauth2-proxy 接 tenant-api）
