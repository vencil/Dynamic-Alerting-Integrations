...
(39 JSX tools + Guided Flows) behind an nginx static server. Designed for
...
# Run
docker run -p 8080:80 ghcr.io/vencil/da-portal:v2.7.0
...
docker run -p 8080:80 \
  ...
  ghcr.io/vencil/da-portal:v2.7.0
```
