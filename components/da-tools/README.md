...
`da-tools` 採用**獨立版號**，與平台版本（v2.0.0-preview.2+）和 threshold-exporter 版號脫鉤：

| 元件 | 版號 | Git Tag | 說明 |
|------|------|---------|------|
| 平台文件 | v2.0.0-preview.2 | `v1.11.0` | Runbook Injection + Recurring Maintenance + Config Drift CI |
