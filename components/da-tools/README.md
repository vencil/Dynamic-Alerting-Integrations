...
> **版本**：1.5.0（獨立版號，與 threshold-exporter 脫鉤）
...
docker pull ghcr.io/vencil/da-tools:1.5.0

# 查看說明
docker run --rm ghcr.io/vencil/da-tools:1.5.0 --help

# 查看版本
docker run --rm ghcr.io/vencil/da-tools:1.5.0 --version
```
