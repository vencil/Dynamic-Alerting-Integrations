...
// HeaderResolver unit tests: the base identity resolution (email / groups /
// provenance) plus the ADR-027 / LD-6 P2 identity-claims seam —
//
...
// --- ParseClaimHeaders (ADR-027 / LD-6 P2) ---
...
// --- HeaderResolver.ClaimHeaders (ADR-027 / LD-6 P2) ---
