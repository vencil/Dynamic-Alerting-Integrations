...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/audit/tenants/{id}/access-report/dry-run": {
            "post": {
                "description": "Evaluates an operator-supplied candidate _rbac.yaml through the\nSAME strict parse+validation pipeline and reverse-report core\nthe live config runs, WITHOUT installing it, and reports what\nwould change for tenant {id}: the live baseline report, the\ncandidate report (config_anchor honestly unanchored; the\nenvelope's candidate_sha256 pins the submitted bytes), and a\nstructural diff paired by rule name before any redaction.\nMutates nothing. Requires the same NON-org-scoped platform\nadmin grant as the GET endpoint; all other callers receive the\nbyte-identical constant 403 (no tenant-enumeration oracle).",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    ...
                    {
                        "description": "Candidate config envelope",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.DryRunRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_handler.DryRunResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/tenants/search": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Case-insensitive substring over id / owner / domain / db_type / tags",
                        "name": "q",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Exact environment",
                        "name": "environment",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Exact db_type",
                        "name": "db_type",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "A tag the tenant must carry (case-sensitive)",
                        "name": "tag",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        ...
        "internal_handler.ConfigDerivedMeta": {
            "type": "object",
            "properties": {
                "config_loaded_at": {
                    "description": "When conf.d was last loaded into the cache the states were evaluated from.",
                    "type": "string"
                },
                "evaluated_at": {
                    "description": "Request time the states were evaluated at (silences and maintenance windows with ` + "`" + `expires` + "`" + ` are judged against it).",
                    "type": "string"
                },
                "load_error": {
                ...
                "parse_failed_hidden": {
                    "description": "Parse-failed files not named in parse_failed_files because the caller's RBAC scope does not cover them.",
                    "type": "integer"
                }
            }
        },
        "internal_handler.ConfigDerivedState": {
            "type": "object",
            "properties": {
                "maintenance_active": {
                    "description": "Whether the exporter would emit user_state_filter{filter=\"maintenance\"} for this tenant.",
                    "type": "boolean"
                },
                "silent_targets": {
                    "description": "Severities whose notifications the exporter's user_silent_mode would silence (\"critical\" / \"warning\"), sorted; [] when none.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "internal_handler.DryRunCandidate": {
            "type": "object",
            "properties": {
                "rbac_yaml": {
                    "type": "string"
        ...
        "internal_handler.DryRunChanged": {
            "type": "object",
            "properties": {
                "candidate_index": {
                    "type": "integer"
                ...
                "unsatisfiable": {
                    "$ref": "#/definitions/internal_handler.BoolDelta"
                }
            }
        },
        "internal_handler.DryRunDiff": {
            "type": "object",
            "properties": {
                "added": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_handler.DryRunAdded"
                    }
                },
                "alignment": {
                    "type": "string"
                ...
                "changed": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_handler.DryRunChanged"
                    }
                },
                "removed": {
                    "type": "array",
        ...
        "internal_handler.DryRunRemoved": {
            "type": "object",
            "properties": {
                "live_index": {
                    "type": "integer"
        ...
        "internal_handler.DryRunRequest": {
            "type": "object",
            "properties": {
                "candidate": {
                    "$ref": "#/definitions/internal_handler.DryRunCandidate"
                }
            }
        },
        "internal_handler.DryRunResponse": {
            "type": "object",
            "properties": {
                "baseline": {
                    "$ref": "#/definitions/github_com_vencil_tenant-api_internal_rbac.ReverseReport"
                ...
                "diff": {
                    "$ref": "#/definitions/internal_handler.DryRunDiff"
                },
                "generated_at": {
                    "type": "string"
                },
        ...
        "internal_handler.SearchResponse": {
            ...
            "properties": {
                "config_derivation": {
                    "$ref": "#/definitions/internal_handler.ConfigDerivedMeta"
                },
                "items": {
                    "type": "array",
                    "items": {
        ...
        "internal_handler.TenantSummary": {
            ...
            "properties": {
                ...
                "silent_mode": {
                    "description": "Raw ` + "`" + `_silent_mode` + "`" + ` value from the tenant's own config file, not the tenant's state (see config_derived); omitted when config_derived cannot be derived.",
                    "type": "string"
                },
                "tags": {
                    "type": "array",
