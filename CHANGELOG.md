...
- `docs/playground.jsx`：Tenant YAML 驗證 Playground
- `docs/rule-pack-selector.jsx`：Rule Pack 選擇器
- `docs/cli-playground.jsx`：CLI 指令建構器
...
> **歷史版本 (v0.1.0–v1.9.0)：** 請參閱 [CHANGELOG-archive.md](CHANGELOG-archive.md)
