...
- **ZH-primary SSOT policy lock**：v2.5.0 評估文 §7 原推薦切換 EN SSOT，pilot 工具於 `v2.7.0` 完成；v2.8.0 套 `testing-playbook §LL §12a` 4-question audit（**Q4 NEW: spec premise validation**）後 reverse 原計畫。Pilot 工具保留 dormant，trigger conditions 明確 codify
...
| 5-anchor e2e fire-through p99 | < 2 s | conf.d 寫入 → webhook receiver 全鏈（n=30, bootstrap 95% CI） |
