...
- 完整報告含 fixture 方法論 / cardinality / memory allocs：`docs/internal/benchmark-v2.7.0-baseline.md` §4（GitHub 上直接瀏覽此路徑；mkdocs 站上同內容位於 `internal/benchmark-v2.7.0-baseline.md`）
