...
- **116 份公開文件** 對照表 → [`docs/internal/doc-map.md`](docs/internal/doc-map.md)（`docs/internal/**` 不入 catalog；那些是 maintainer / AI agent 用的 playbook/planning，由 CLAUDE.md / skills 直接引用）
- **124 個 Python 工具** → [`docs/internal/tool-map.md`](docs/internal/tool-map.md)；CLI 速查：`da-tools <cmd> --help`
